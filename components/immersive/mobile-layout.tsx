...
export function MobileLayout({
  ...
  return (
    <>
      ...
      <nav
        className="animate-slide-in-bottom-dock absolute inset-x-3 bottom-2 z-40 overflow-visible rounded-2xl border border-zinc-700/80 bg-background/90 px-1 pt-2 pb-1.5 shadow-[0_10px_35px_rgba(0,0,0,0.85),0_0_20px_oklch(0.85_0.2_128/0.2)] backdrop-blur-2xl"
