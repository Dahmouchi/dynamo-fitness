  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <button
        ...
        className={`animate-slide-in-bottom-dock fixed right-4 bottom-24 z-10 flex size-12 cursor-pointer items-center justify-center rounded-2xl border-2 transition-all duration-300 active:scale-95 shadow-[0_10px_25px_rgba(0,0,0,0.7)] ${
          isOpen
